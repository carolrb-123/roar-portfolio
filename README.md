...
This portfolio documents technical ownership of key subsystems on **ASU ROAR**, an autonomous Mars rover competing in the [European Rover Challenge](https://roverchallenge.eu/) (ERC). The competition takes place September 4–6, 2026 in Krakow, Poland at AGH University. The work spans two years of active development and represents the full cycle from problem definition through validation on live hardware.
